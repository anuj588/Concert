...
export default function Navbar(){
    ...
    <div>
        <nav className="navbar fixed-top navbar-expand-lg navbar-dark bg-gradient text-black fw-bold opacity-75 border-bottom border-white" style={{background:'#ffa502'}}>
         ...
         <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <Link className="nav-link active" aria-current="page" to="/">Home</Link>
            ...
            <li className="nav-item">
            <Link className="nav-link active" aria-current="page" to="/concert">Concert</Link>
            </li> 
            <li className="nav-item">
